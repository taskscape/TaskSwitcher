...
namespace ManagedWinapi
{
    ...
    public class TextCursorProvider : Component, IExtenderProvider
    {
        ...
        [DefaultValue(1)]
        [Description(
            "The width of the caret in pixels. If the caret exceeds the bounds of the Control, it is clipped.")]
        public int Width
        {
        ...
        [DefaultValue(null)]
        [Description(
            "A custom bitmap image used to render the caret. If null, the caret will take have the usual block form. If the image height exceeds the Control height, it is automatically truncated.")]
        ...
        [DefaultValue(false)]
        [Description(
            "When true, the caret properties, as specified by the TextCursorProvider component instance, will be applied to the caret used for this Control.")]
